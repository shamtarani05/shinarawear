  ...
  useEffect(() => {
    const fetchNewArrivals = async () => {
      try {
        setLoading(true);
        setError(null);
        let url = `http://localhost:3000/products?sort=createdAt&page=${currentPage}&limit=${PRODUCTS_PER_PAGE}`;
    ...
    <>
      ...
      <main className={styles.mainContent}>
        <section className={styles.productsSection}>
          <div className={styles.sectionTitle}>All New Arrivals</div>
          <CategoryFilter
          ...
          {loading ? (
            ...
            <div className={styles.noProducts}><p>No new arrivals found.</p></div>
          ) : (
